...
class String
{
 ...
 public:
   ...
   *
   * Internally, a cvc5pp::internal::String is represented by a vector of unsigned
   ...
   * cvc5pp::internal::String correspond one-to-one with the input string.
   */
  String() = default;
   ...
   *    cvc5pp::internal::String( s ).toString() = s.
   */
