...
#define CVC5_LIT_ITE_DFN(T)                                                    \
  template <>                                                                  \
  struct ite<cvc5pp::internal::symfpuLiteral::Cvc5Prop, T>                       \
  {                                                                            \
    static const T& iteOp(const cvc5pp::internal::symfpuLiteral::Cvc5Prop& cond, \
                          const T& l,                                          \
                          const T& r)                                          \
    {                                                                          \
      return cond ? l : r;                                                     \
...
CVC5_LIT_ITE_DFN(cvc5pp::internal::symfpuLiteral::traits::rm);
CVC5_LIT_ITE_DFN(cvc5pp::internal::symfpuLiteral::traits::prop);
CVC5_LIT_ITE_DFN(cvc5pp::internal::symfpuLiteral::traits::sbv);
CVC5_LIT_ITE_DFN(cvc5pp::internal::symfpuLiteral::traits::ubv);
