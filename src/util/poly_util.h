...
/** Converts a poly::Integer to a cvc5pp::internal::Integer. */
Integer toInteger(const poly::Integer& i);
/** Converts a poly::Integer to a cvc5pp::internal::Rational. */
Rational toRational(const poly::Integer& r);
/** Converts a poly::Rational to a cvc5pp::internal::Rational. */
Rational toRational(const poly::Rational& r);
/** Converts a poly::DyadicRational to a cvc5pp::internal::Rational. */
Rational toRational(const poly::DyadicRational& dr);

/** Converts a poly::Value to a cvc5pp::internal::Rational (that may be a bit above). */
Rational toRationalAbove(const poly::Value& v);
/** Converts a poly::Value to a cvc5pp::internal::Rational (that may be a bit below). */
Rational toRationalBelow(const poly::Value& v);

/** Converts a cvc5pp::internal::Integer to a poly::Integer. */
poly::Integer toInteger(const Integer& i);
/** Converts a vector of cvc5pp::internal::Integers to a vector of poly::Integers. */
std::vector<poly::Integer> toInteger(const std::vector<Integer>& vi);
/** Converts a cvc5pp::internal::Rational to a poly::Rational. */
poly::Rational toRational(const Rational& r);
/**
 * Converts a cvc5pp::internal::Rational to a poly::DyadicRational. If the input is not
 ...
 * cvc5pp::internal::Rational bounds. As a poly::AlgebraicNumber works on
...
/**
 * Constructs a cvc5pp::internal::RealAlgebraicNumber, simply wrapping
