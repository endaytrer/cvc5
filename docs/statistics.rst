...
The statistics can be inspected via the :cpp:func:`Solver::getStatistics() <cvc5pp::Solver::getStatistics()>` API
...
Statistics, obtained via :cpp:func:`Solver::getStatistics() <cvc5pp::Solver::getStatistics()>`,
...
:cpp:class:`Statistics <cvc5pp::Statistics>` object or by querying it by name.

A statistic value (of type :cpp:class:`Stat <cvc5pp::Stat>`) has two general
properties, :cpp:func:`isInternal() <cvc5pp::Stat::isInternal()>` and
:cpp:func:`isDefault() <cvc5pp::Stat::isDefault()>`.
:cpp:func:`isInternal() <cvc5pp::Stat::isInternal()>` indicates whether a
...
:cpp:func:`isDefault() <cvc5pp::Stat::isDefault()>` checks whether the
