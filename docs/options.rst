...
- C++ API: :cpp:func:`setOption() <cvc5pp::Solver::setOption()>`,
  :cpp:func:`getOption() <cvc5pp::Solver::getOption()>`,
  :cpp:func:`getOptionNames() <cvc5pp::Solver::getOptionNames()>`,
  :cpp:func:`getOptionInfo() <cvc5pp::Solver::getOptionInfo()>`
